...
<head>
    ...
    <title>Quản lý Khách hàng - Hệ thống Quản lý Khách sạn</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="${pageContext.request.contextPath}/admin/customers?action=list" class="active">Khách hàng</a></li>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/customers?action=add" class="btn btn-primary">+ Thêm khách hàng mới</a>
        </div>
        ...
        <div class="search-box">
            <form method="get" action="${pageContext.request.contextPath}/admin/customers">
                ...
                <input type="text" name="query" placeholder="🔍 Tìm kiếm khách hàng theo tên, email hoặc số điện thoại..." 
                       value="${param.query}">
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="${pageContext.request.contextPath}/admin/customers?action=delete&id=${customer.id}" 
                                   ...
                                   onclick="return confirm('Bạn có chắc chắn muốn xóa khách hàng ${customer.fullName}?')">Xóa</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <c:if test="${empty customers}">
            <div style="text-align: center; padding: 3rem; background: white; border-radius: 10px; margin-top: 2rem;">
                <h3 style="color: #666;">Không tìm thấy khách hàng nào</h3>
                <p style="color: #999; margin-top: 1rem;">Thêm khách hàng đầu tiên để bắt đầu</p>
            </div>
        </c:if>
    </div>
</body>
