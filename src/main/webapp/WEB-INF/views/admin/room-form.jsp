...
<head>
    ...
    <title>${room.id == 0 ? 'Thêm' : 'Sửa'} Phòng - Quản lý Khách sạn</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="form-card">
            <h2>${room.id == 0 ? '➥ Thêm phòng mới' : '✏️ Sửa thông tin phòng'}</h2>
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/rooms">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="roomNumber" name="roomNumber" 
                           ...
                           placeholder="Ví dụ: 101, 201, A-301">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="roomType" name="roomType" required>
                        ...
                        <option value="Single" ${room.roomType == 'Single' ? 'selected' : ''}>Phòng đơn</option>
                        <option value="Double" ${room.roomType == 'Double' ? 'selected' : ''}>Phòng đôi</option>
                        <option value="Suite" ${room.roomType == 'Suite' ? 'selected' : ''}>Phòng Suite</option>
                        <option value="Deluxe" ${room.roomType == 'Deluxe' ? 'selected' : ''}>Phòng Deluxe</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <label for="capacity">Sức chứa (Khách) <span class="required">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" 
                              placeholder="Nhập mô tả phòng, tiện nghi...">${room.description}</textarea>
                </div>

                <div class="form-actions">
                    <a href="${pageContext.request.contextPath}/admin/rooms?action=list" class="btn btn-secondary">Hủy</a>
                    <button type="submit" class="btn btn-primary">
                        ${room.id == 0 ? 'Thêm phòng' : 'Cập nhật'}
                    </button>
                </div>
            </form>
        </div>
