...
public class RoomServlet extends HttpServlet {
    ...
    private void listRooms(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (filterType != null && !filterType.isEmpty()) {
            rooms = roomBO.getRoomsByType(filterType);
        } else {
    ...
    private void addRoom(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (roomBO.addRoom(room)) {
            response.sendRedirect(request.getContextPath() + "/rooms?action=list&success=add");
        } else {
    ...
    private void updateRoom(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (roomBO.updateRoom(room)) {
            response.sendRedirect(request.getContextPath() + "/rooms?action=list&success=update");
        } else {
    ...
    private void deleteRoom(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/rooms?action=list&success=delete");
    }
    ...
    private void updateRoomStatus(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/rooms?action=list&success=status");
    }
}
