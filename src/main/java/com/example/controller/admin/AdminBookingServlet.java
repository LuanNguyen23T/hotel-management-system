...
public class AdminBookingServlet extends HttpServlet {
    ...
    private void addBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (bookingBO.addBooking(booking)) {
                response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=add");
            } else {
    ...
    private void updateBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (bookingBO.updateBooking(booking)) {
                response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=update");
            } else {
    ...
    private void deleteBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=delete");
    }
    ...
    private void confirmBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=confirm");
    }
    ...
    private void checkInBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=checkin");
    }
    ...
    private void checkOutBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=checkout");
    }
    ...
    private void cancelBooking(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect(request.getContextPath() + "/admin/bookings?action=list&success=cancel");
    }
}
