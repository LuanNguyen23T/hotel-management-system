...
<head>
    ...
    <title>Đặt phòng - Hotel Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value" style="color: #667eea;">
                                <fmt:formatNumber value="${room.pricePerNight}" pattern="#,###"/> VNĐ
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/customer/booking">
                    ...
                    <div id="pricePreview" class="price-preview" style="display: none;">
                        <h4 style="margin-bottom: 1rem; color: #2c3e50;">Chi tiết giá</h4>
                        <div class="price-row">
                            <span>Số đêm:</span>
                        ...
                        <div class="price-row">
                            ...
                            <span><fmt:formatNumber value="${room.pricePerNight}" pattern="#,###"/> VNĐ</span>
                        </div>
